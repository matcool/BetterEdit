...
bool RGBColorInputWidget::init(ColorSelectPopup* parent) {
	...
	ccColor3B const placeholder_color = { 100, 100, 100 };
	...
	green_input->setMaxLabelWidth(3);
