...
bool BrownAlertDelegate::init(float _w, float _h, char const* _spr, char const* _title) {
	...
	if (sizeof _title > 0) {
		...
		title->setPosition(winSize.width / 2, winSize.height / 2 + this->m_pLrSize.height / 2 - 25);
	...
	auto closeBtn = CCMenuItemSpriteExtra::create(
		closeSpr, this, (cocos2d::SEL_MenuHandler)&BrownAlertDelegate::onClose
	);
